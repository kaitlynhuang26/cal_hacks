# """
# PostureBot — MCP Client for ChatGPT Integration
# Connects ChatGPT to your local posture necklace API using the Model Context Protocol.
# """
...
# #  Temporary: hardcoded API key for local test only
...
# class MCPClient:
#     def __init__(self, openai_api_key: str, mcp_server_url: str = "http://localhost:3000"):
...
#     async def chat_with_tools(self, user_message: str, model: str = "gpt-4o-mini") -> str:
#         """Send a message to ChatGPT that only responds to posture-related queries"""
#         try:
...
#                         "If a question is unrelated to posture, neck angle, slouching, ergonomics, or breathing, "
...
# class MCPChatGPT:
#     """Simple interface for PostureBot"""

#     def __init__(self, openai_api_key: str, mcp_server_url: str = "http://localhost:3000"):
#         self.client = MCPClient(openai_api_key, mcp_server_url)
...
#     bot = MCPChatGPT(openai_api_key)

#     response = await bot.chat("How’s my posture looking today?", model="gpt-4o-mini")
#     print("\n🤖 PostureBot:", response)
...
class MCPClient:
    def __init__(self, groq_api_key: str, mcp_server_url: str = "http://localhost:3000"):
