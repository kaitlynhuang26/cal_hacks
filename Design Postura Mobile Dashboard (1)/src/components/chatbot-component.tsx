...
export function ChatBot({ onClose }: ChatBotProps) {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          id: (Date.now() + 1).toString(),
          text: "Sorry, I couldn’t connect to the posture server. Please try again soon.",
          sender: "bot",
          timestamp: new Date(),
        },
      ]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div
        className={`relative w-full max-w-md h-[85vh] rounded-t-3xl shadow-2xl flex flex-col transform transition-all duration-300 animate-slideUp ${
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-white font-medium">Postura AI</h2>
